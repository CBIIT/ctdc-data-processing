...
def gene_fusion_variant_transformation(gene_fusion_variant_file_name, log, input_files, output_folder):
    ...
    input_file_name = os.path.splitext(input_files['gene_fusion_variant'])[0]
