...
def copy_number_variant_transformation(copy_number_variant_file_name, log, input_files, output_folder):
    ...
    for index in range(len(copy_number_variant_df)):
        ...
        new_copyNumber.append(round(copy_number_variant_df['copy_number_variant_of$copyNumber'].iloc[index], 2))
        new_confidenceInterval5percent.append(round(copy_number_variant_df['copy_number_variant_of$confidenceInterval5percent'].iloc[index], 2))
        new_confidenceInterval95percent.append(round(copy_number_variant_df['copy_number_variant_of$confidenceInterval95percent'].iloc[index], 2))
